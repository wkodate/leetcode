package com.wkodate.leetcode.LC0886_PossibleBipartition;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        // false
        System.out.println(s.possibleBipartition(4, new int[][] { { 1, 2 }, { 1, 3 }, { 2, 3 } }));
        // false
        System.out.println(
                s.possibleBipartition(5, new int[][] { { 1, 2 }, { 2, 3 }, { 3, 4 }, { 4, 5 }, { 1, 5 } }));
        // true
        int[][] dislikes = {
        ...
        // true
        int[][] dislikes2 = {
                { 4, 7 }, { 4, 8 }, { 5, 6 }, { 1, 6 }, { 3, 7 }, { 2, 5 }, { 5, 8 }, { 1, 2 }, { 4, 9 },
                { 6, 10 }, { 8, 10 }, { 3, 6 }, { 2, 10 }, { 9, 10 }, { 3, 9 }, { 2, 3 }, { 1, 9 }, { 4, 6 },
                { 5, 7 }, { 3, 8 }, { 1, 8 }, { 1, 7 }, { 2, 4 }
        };
        System.out.println(s.possibleBipartition(10, dislikes2));
    }
